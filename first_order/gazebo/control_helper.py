...
class MavrosHelper(object):
    def __init__(self, drone_id):
        ...
        try:
            rospy.wait_for_service('/' + self.drone_id + '/' + 'mavros/param/get', service_timeout)
            rospy.wait_for_service('/' + self.drone_id + '/' + 'mavros/cmd/arming', service_timeout)
            rospy.wait_for_service('/' + self.drone_id + '/' + 'mavros/mission/push', service_timeout)
            rospy.wait_for_service('/' + self.drone_id + '/' + 'mavros/mission/clear', service_timeout)
            rospy.wait_for_service('/' + self.drone_id + '/' + 'mavros/set_mode', service_timeout)
            rospy.loginfo("ROS services are up")
        except rospy.ROSException:
            self.fail("failed to connect to services")

        self.get_param_srv = rospy.ServiceProxy('/' + self.drone_id + '/' + 'mavros/param/get', ParamGet)
        self.set_arming_srv = rospy.ServiceProxy('/' + self.drone_id + '/' + 'mavros/cmd/arming', CommandBool)
        self.set_mode_srv = rospy.ServiceProxy('/' + self.drone_id + '/' + 'mavros/set_mode', SetMode)
        self.wp_clear_srv = rospy.ServiceProxy('/' + self.drone_id + '/' + 'mavros/mission/clear',WaypointClear)
        self.wp_push_srv = rospy.ServiceProxy('/' + self.drone_id + '/' + 'mavros/mission/push', WaypointPush)
        print('/' + self.drone_id + '/' + 'mavros/set_mode')
        # ROS subscribers
        self.alt_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/altitude', Altitude, self.altitude_callback)
        self.ext_state_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/extended_state',ExtendedState, self.extended_state_callback)
        self.global_pos_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/global_position/global', NavSatFix, self.global_position_callback)
        self.home_pos_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/home_position/home', HomePosition, self.home_position_callback)
        self.local_pos_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/local_position/pose', PoseStamped, self.local_position_callback)
        self.mission_wp_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/mission/waypoints', WaypointList, self.mission_wp_callback)
        self.state_sub = rospy.Subscriber('/' + self.drone_id + '/' + 'mavros/state', State, self.state_callback)
